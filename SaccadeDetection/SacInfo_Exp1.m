%% Saccade info (Step 3)
% Run this after Automatic detection of saccades (SacDetect_Exp1) and
% visual inspection (SacInspect_Exp1)
codepath = '';
...
load([datapath,'ET_clean_saccades_Exp1.mat']); clearvars movement_clean_left movement_clean_right
...
% 4: take out saccades that was counted multiple time
...
for s = 1:length(Mem)
    ...
    %% save
    savename = [sacsavepath,sprintf('Sac_PV_Info_Sub%d_%s.mat',s,'Exp1')];
