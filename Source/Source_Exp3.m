...
for s = 1:20
    ...
    cfg= [];
    cfg.trials = ismember(eeg_final.trialinfo(:,1),Eye_trlinfo(Eye_trlinfo(:,8)==1,1));
    eeg_all  = ft_selectdata(cfg, eeg_final);
      
    eeg_all.trialinfo(:,2:8) = Eye_trlinfo(ismember(Eye_trlinfo(:,1),eeg_all.trialinfo(:,1)),2:8);
    ...
    %% Exploration Index
    cri = nanmedian(eeg_all.trialinfo(:,7));
    
    % More Exploration
    cfg= [];
    cfg.latency = bl;
    cfg.trials = eeg_all.trialinfo(:,7)<=cri;
    dataPre_MoreExplr  = ft_selectdata(cfg, eeg_all);
    
   
    cfg.latency = [0.5 4];
    cfg.trials = eeg_all.trialinfo(:,7)<=cri;
    dataPost_MoreExplr = ft_selectdata(cfg,eeg_all);
    ...
    cfg.latency = bl;
    cfg.trials = eeg_all.trialinfo(:,7)>=cri;
    dataPre_LessExplr  = ft_selectdata(cfg, eeg_all);
    
   
    cfg.latency = [0.5 4];
    cfg.trials = eeg_all.trialinfo(:,7)>=cri;
    dataPost_LessExplr = ft_selectdata(cfg,eeg_all);
    
    n_trl_MoreLessExplr(s,1) = sum(eeg_all.trialinfo(:,7)<=cri);
    n_trl_MoreLessExplr(s,2) = sum(eeg_all.trialinfo(:,7)>=cri);
    ...
    cfg.tapsmofrq = taps;
    cfg.foilim    = foi_freq;
    freqPre_MoreExplr = ft_freqanalysis(cfg, dataPre_MoreExplr);
    freqPost_MoreExplr = ft_freqanalysis(cfg, dataPost_MoreExplr);
    freqPre_LessExplr = ft_freqanalysis(cfg, dataPre_LessExplr);
    freqPost_LessExplr = ft_freqanalysis(cfg, dataPost_LessExplr);  
    ...
    dataAll_MoreExplr = ft_appenddata([], dataPre_MoreExplr, dataPost_MoreExplr);
    dataAll_LessExplr = ft_appenddata([], dataPre_LessExplr, dataPost_LessExplr);
    ...
    freqAll_MoreExplr = ft_freqanalysis(cfg, dataAll_MoreExplr);
    freqAll_LessExplr = ft_freqanalysis(cfg, dataAll_LessExplr);
    ...
    sourceAll_MoreExplr = ft_sourceanalysis(cfg, freqAll_MoreExplr);
    sourceAll_LessExplr = ft_sourceanalysis(cfg, freqAll_LessExplr);
    ...
    cfg.sourcemodel.filter = sourceAll_MoreExplr.avg.filter;
    sourcePre_MoreExplr  = ft_sourceanalysis(cfg, freqPre_MoreExplr );
    sourcePost_MoreExplr = ft_sourceanalysis(cfg, freqPost_MoreExplr);
    
    cfg.sourcemodel.filter = sourceAll_LessExplr.avg.filter;
    sourcePre_LessExplr  = ft_sourceanalysis(cfg, freqPre_LessExplr );
    sourcePost_LessExplr = ft_sourceanalysis(cfg, freqPost_LessExplr);
    ...
    sourceDiff_MoreExplr = sourcePost_MoreExplr;
    sourceDiff_MoreExplr.avg.pow = ( sourcePost_MoreExplr.avg.pow -sourcePre_MoreExplr.avg.pow) ./ sourcePre_MoreExplr.avg.pow;
    
    sourceDiff_LessExplr = sourcePost_LessExplr;
    sourceDiff_LessExplr.avg.pow = ( sourcePost_LessExplr.avg.pow -sourcePre_LessExplr.avg.pow) ./ sourcePre_LessExplr.avg.pow;
    ...
    s_DiffInt_MoreExplr{s}  = ft_sourceinterpolate(cfg, sourceDiff_MoreExplr , mri);
    s_DiffInt_LessExplr{s}  = ft_sourceinterpolate(cfg, sourceDiff_LessExplr , mri);
...
stat_Explr   = ft_sourcestatistics(cfg, s_DiffInt_MoreExplr{subset}, s_DiffInt_LessExplr{subset});

%% save output
stat_Explr = rmfield(stat_Explr,'cfg');% remove cfg to save space
save([datafigspath,'Fig3E_right.mat'],'stat_Explr')
...
%load( [datafigspath,'Fig3E_right.mat'])
