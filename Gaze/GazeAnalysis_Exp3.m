...
save([datafigspath,'SuppleFig9_right31.mat'],'stat_EI','Gaze_MoreExplr','Gaze_LessExplr')
save([datafigspath,'SuppleFig10A_left.mat'],'stat_Sac')
%% Figure
...
%%
load([datafigspath,'SuppleFig10A_left.mat'])
...
%
fig_savename1 = 'SuppleFig10A_left';
...
imAlpha(isnan(squeeze(stat_Sac.stat))) = 0;% replace the NaN with 0 for visualization
